...
Partial Class UmSonho
    ...
    Private Sub InitializeComponent()
        Dim resources As ComponentModel.ComponentResourceManager = New ComponentModel.ComponentResourceManager(GetType(UmSonho))
        ...
        Label4.Location = New Point(680, 334)
        Label4.Name = "Label4"
        Label4.Size = New Size(161, 20)
        Label4.TabIndex = 31
        Label4.Text = "Autor: Nicholas Sparks "
        ' 
        ' Label3
        ' 
