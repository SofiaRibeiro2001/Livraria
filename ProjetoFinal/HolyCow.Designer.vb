...
Partial Class HolyCow
    ...
    Private Sub InitializeComponent()
        Dim resources As ComponentModel.ComponentResourceManager = New ComponentModel.ComponentResourceManager(GetType(HolyCow))
        ...
        Cmd_voltar.Location = New Point(809, 428)
        Cmd_voltar.Name = "Cmd_voltar"
        Cmd_voltar.Size = New Size(73, 28)
        Cmd_voltar.TabIndex = 15
        ...
        Label6.Location = New Point(276, 108)
        Label6.Name = "Label6"
        ...
        Label5.Location = New Point(226, 364)
        Label5.Name = "Label5"
        ...
        Label4.Location = New Point(680, 356)
        Label4.Name = "Label4"
        Label4.Size = New Size(161, 20)
        Label4.TabIndex = 17
        Label4.Text = "Autor: David Duchovny"
        ' 
        ' Label3
        ' 
        ...
        PictureBox5.Location = New Point(29, 108)
        ...
        Label2.Location = New Point(573, 32)
        Label2.Name = "Label2"
        Label2.Size = New Size(268, 25)
        Label2.TabIndex = 7
        Label2.Text = "Holy Cow - Uma Fábula Animal"
        ' 
        ' HolyCow
        ' 
