...
Partial Class LivrodaNoite
    ...
    Private Sub InitializeComponent()
        Dim resources As ComponentModel.ComponentResourceManager = New ComponentModel.ComponentResourceManager(GetType(LivrodaNoite))
        ...
        Label4.Location = New Point(710, 326)
        Label4.Name = "Label4"
        Label4.Size = New Size(131, 20)
        Label4.TabIndex = 38
        Label4.Text = "Autor: Holly Black "
        ' 
        ' Label3
        ' 
        ...
        Label2.Location = New Point(711, 32)
        Label2.Name = "Label2"
        Label2.Size = New Size(130, 25)
        Label2.TabIndex = 7
        Label2.Text = "Livro da Noite"
        ' 
        ' LivrodaNoite
        ' 
