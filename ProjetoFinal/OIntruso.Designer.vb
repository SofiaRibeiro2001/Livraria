...
Partial Class OIntruso
    ...
    Private Sub InitializeComponent()
        Dim resources As ComponentModel.ComponentResourceManager = New ComponentModel.ComponentResourceManager(GetType(OIntruso))
        Label7 = New Label()
        Label6 = New Label()
        Label4 = New Label()
        Label3 = New Label()
        ...
        Label4.Location = New Point(700, 354)
        Label4.Name = "Label4"
