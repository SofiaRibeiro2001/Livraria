...
Partial Class Comedia
    ...
    Private Sub InitializeComponent()
        Dim resources As ComponentModel.ComponentResourceManager = New ComponentModel.ComponentResourceManager(GetType(Comedia))
        Button6 = New Button()
        Button3 = New Button()
        Button2 = New Button()
        Button1 = New Button()
        ...
        Button3.Location = New Point(269, 260)
        ...
        Button1.Location = New Point(269, 74)
        ...
        Cmd_voltar.Location = New Point(0, 423)
