...
Partial Class Lixo
    ...
    Private Sub InitializeComponent()
        Dim resources As ComponentModel.ComponentResourceManager = New ComponentModel.ComponentResourceManager(GetType(Lixo))
        ...
        Label4.Location = New Point(662, 276)
        Label4.Name = "Label4"
        Label4.Size = New Size(179, 20)
        Label4.TabIndex = 24
        Label4.Text = "Autor: Hugo van der Ding"
        ' 
        ' Label3
        ' 
        ...
        Label2.Location = New Point(631, 32)
        Label2.Name = "Label2"
        Label2.Size = New Size(210, 25)
        Label2.TabIndex = 7
        Label2.Text = "O Lixo na Minha Cabeça"
        ' 
        ' Lixo
        ' 
