...
Partial Class MorteSuspeita
    ...
    Private Sub InitializeComponent()
        Dim resources As ComponentModel.ComponentResourceManager = New ComponentModel.ComponentResourceManager(GetType(MorteSuspeita))
        Label7 = New Label()
        Label6 = New Label()
        Label4 = New Label()
        Label3 = New Label()
        ...
        Label7.Location = New Point(237, 373)
        Label7.Name = "Label7"
        ...
        Label6.Location = New Point(276, 97)
        Label6.Name = "Label6"
        ...
        Label4.Location = New Point(664, 334)
        Label4.Name = "Label4"
        Label4.Size = New Size(177, 20)
        Label4.TabIndex = 22
        Label4.Text = "Autor: Robert Thorogood"
        ' 
        ' Label3
        ' 
        Label3.BackColor = SystemColors.ControlLight
        Label3.Location = New Point(276, 122)
        Label3.Name = "Label3"
        Label3.Size = New Size(565, 212)
        Label3.TabIndex = 21
        ...
        PictureBox5.Location = New Point(29, 97)
        ...
        Label2.Location = New Point(601, 32)
        Label2.Name = "Label2"
        Label2.Size = New Size(240, 25)
        Label2.TabIndex = 7
        Label2.Text = "Morte Suspeita em Marlow"
        ' 
        ' Cmd_voltar
        ' 
