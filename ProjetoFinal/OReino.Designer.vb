...
Partial Class OReino
    ...
    Private Sub InitializeComponent()
        Dim resources As ComponentModel.ComponentResourceManager = New ComponentModel.ComponentResourceManager(GetType(OReino))
        ...
        Label4.Location = New Point(675, 340)
        Label4.Name = "Label4"
        Label4.Size = New Size(166, 20)
        Label4.TabIndex = 38
        Label4.Text = "Autor: Kerri Maniscalco "
        ' 
        ' Label3
        ' 
        ...
        Label2.Location = New Point(606, 32)
        Label2.Name = "Label2"
        Label2.Size = New Size(235, 25)
        Label2.TabIndex = 7
        Label2.Text = "O Reino dos Amaldiçoados"
        ' 
        ' OReino
        ' 
