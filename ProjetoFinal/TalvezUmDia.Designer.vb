...
Partial Class TalvezUmDia
    ...
    Private Sub InitializeComponent()
        Dim resources As ComponentModel.ComponentResourceManager = New ComponentModel.ComponentResourceManager(GetType(TalvezUmDia))
        ...
        Label4.Location = New Point(685, 346)
        Label4.Name = "Label4"
        ...
        Label2.Location = New Point(716, 32)
        Label2.Name = "Label2"
        Label2.Size = New Size(125, 25)
        Label2.TabIndex = 7
        Label2.Text = "Talvez um Dia"
        ' 
        ' TalvezUmDia
        ' 
