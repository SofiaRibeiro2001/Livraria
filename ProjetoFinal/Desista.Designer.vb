...
Partial Class Desista
    ...
    Private Sub InitializeComponent()
        Dim resources As ComponentModel.ComponentResourceManager = New ComponentModel.ComponentResourceManager(GetType(Desista))
        ...
        Label4.TabIndex = 24
        Label4.Text = "Autor: Henrique Costa Santos"
        ' 
        ' Label3
        ' 
        ...
        Label2.Location = New Point(568, 32)
        Label2.Name = "Label2"
        Label2.Size = New Size(273, 25)
        Label2.TabIndex = 7
        Label2.Text = "Desista - Vai ficar tudo péssimo"
        ' 
        ' Desista
        ' 
        ...
        Name = "Desista"
        Text = "Desista - Vai ficar tudo péssimo"
